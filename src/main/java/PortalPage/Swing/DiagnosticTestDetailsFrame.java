...
public class DiagnosticTestDetailsFrame extends JFrame {
    ...
    private TestType determineTestType(Object detailedTest) {
        Map<Class<?>, TestType> typeMapping = Map.of(
                Models.BloodCountLab.class, TestType.BLOOD_LAB,
                Models.BiochemistryLab.class, TestType.BIOCHEMISTRY_LAB,
                Models.ImmunologyLab.class, TestType.IMMUNOLOGY_LAB,
                Models.MicrobiologyLab.class, TestType.MICROBIOLOGY_LAB
        );
